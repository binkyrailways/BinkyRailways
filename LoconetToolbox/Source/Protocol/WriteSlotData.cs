...
namespace LocoNetToolBox.Protocol
{
    ...
    /// OPC_WR_SL_DATA
    /// </summary>
    public class WriteSlotData : Request
    {
        /// <summary>
        /// Default ctor
        /// </summary>
        public WriteSlotData(int slot)
        {
            Slot = slot;
        }
        ...
        {
            return string.Format("OPC_WR_SL_DATA slot:{0}, stat1:{1}, addr:{2}, spd:{3}, dirf:{4}, trk:{5}, stat2:{6}, snd:{7}, id1:{8}, id2:{9}",
