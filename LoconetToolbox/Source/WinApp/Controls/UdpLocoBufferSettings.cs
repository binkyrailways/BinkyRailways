...
{
    public partial class UdpLocoBufferSettings : UserControl
    {
        private Protocol.UdpLocoBuffer locoBuffer;
        private bool initialized = false;

        /// <summary>
        /// Default ctor
        /// </summary>
        public UdpLocoBufferSettings()
        {
            InitializeComponent();
        ...
        /// Set data
        /// </summary>
        internal Protocol.UdpLocoBuffer LocoBuffer
        {
            set
            {
                if (locoBuffer != null)
