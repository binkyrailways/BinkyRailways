...
const BinkyNetDeviceType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'PCF8574', '2': 3},
    const {'1': 'ADS1115', '2': 4},
    const {'1': 'BINKYCARSENSOR', '2': 5},
    const {'1': 'MQTT_GPIO', '2': 6},
    const {'1': 'MQTT_SERVO', '2': 7},
  ],
};

/// Descriptor for `BinkyNetDeviceType`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List binkyNetDeviceTypeDescriptor = $convert.base64Decode('ChJCaW5reU5ldERldmljZVR5cGUSDAoITUNQMjMwMDgQABIMCghNQ1AyMzAxNxABEgsKB1BDQTk2ODUQAhILCgdQQ0Y4NTc0EAMSCwoHQURTMTExNRAEEhIKDkJJTktZQ0FSU0VOU09SEAUSDQoJTVFUVF9HUElPEAYSDgoKTVFUVF9TRVJWTxAH');
...
const Module$json = const {
  ...
  '2': const [
    ...
    const {'1': 'background_image_url', '3': 6, '4': 1, '5': 9, '10': 'backgroundImageUrl'},
...
final $typed_data.Uint8List moduleDescriptor = $convert.base64Decode('');
...
const CommandStation$json = const {
  ...
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'description', '3': 2, '4': 1, '5': 9, '10': 'description'},
    const {'1': 'address_spaces', '3': 3, '4': 3, '5': 9, '10': 'addressSpaces'},
...
final $typed_data.Uint8List commandStationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List binkyNetCommandStationDescriptor = $convert.base64Decode('');
...
const BinkyNetLocalWorker$json = const {
  ...
  '2': const [
    ...
    const {'1': 'routers', '3': 12, '4': 3, '5': 11, '6': '.binkyrailways.v1.BinkyNetRouter', '10': 'routers'},
  ],
};

/// Descriptor for `BinkyNetLocalWorker`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List binkyNetLocalWorkerDescriptor = $convert.base64Decode('');
...
@$core.Deprecated('Use binkyNetRouterDescriptor instead')
const BinkyNetRouter$json = const {
  '1': 'BinkyNetRouter',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'description', '3': 2, '4': 1, '5': 9, '10': 'description'},
...
/// Descriptor for `BinkyNetRouter`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List binkyNetRouterDescriptor = $convert.base64Decode('Cg5CaW5reU5ldFJvdXRlchIOCgJpZBgBIAEoCVICaWQSIAoLZGVzY3JpcHRpb24YAiABKAlSC2Rlc2NyaXB0aW9u');
@$core.Deprecated('Use binkyNetRouterRefDescriptor instead')
const BinkyNetRouterRef$json = const {
  '1': 'BinkyNetRouterRef',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
  ],
...
/// Descriptor for `BinkyNetRouterRef`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List binkyNetRouterRefDescriptor = $convert.base64Decode('ChFCaW5reU5ldFJvdXRlclJlZhIOCgJpZBgBIAEoCVICaWQ=');
...
const BinkyNetDevice$json = const {
  ...
  '2': const [
    ...
    const {'1': 'router', '3': 6, '4': 1, '5': 11, '6': '.binkyrailways.v1.BinkyNetRouterRef', '10': 'router'},
...
final $typed_data.Uint8List binkyNetDeviceDescriptor = $convert.base64Decode('');
...
@$core.Deprecated('Use binkyNetObjectDescriptor instead')
const BinkyNetObject_ConfigurationEntry$json = const {
...
final $typed_data.Uint8List binkyNetObjectDescriptor = $convert.base64Decode('');
