...
final $typed_data.Uint8List binkyNetDeviceTypeDescriptor = $convert.base64Decode('ChJCaW5reU5ldERldmljZVR5cGUSDAoITUNQMjMwMDgQABIMCghNQ1AyMzAxNxABEgsKB1BDQTk2ODUQAhILCgdQQ0Y4NTc0EAMSCwoHQURTMTExNRAEEhIKDkJJTktZQ0FSU0VOU09SEAUSDQoJTVFUVF9HUElPEAYSDgoKTVFUVF9TRVJWTxAHEggKBEdQSU8QCA==');
...
const Module$json = const {
  ...
  '2': const [
    ...
    const {'1': 'railPoints', '3': 108, '4': 3, '5': 11, '6': '.binkyrailways.v1.RailPointRef', '10': 'railPoints'},
...
final $typed_data.Uint8List moduleDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List binkyNetLocalWorkerDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List binkyNetRouterDescriptor = $convert.base64Decode('Cg5CaW5reU5ldFJvdXRlchIOCgJpZBgBIAEoCVICaWQSIAoLZGVzY3JpcHRpb24YAiABKAlSC2Rlc2NyaXB0aW9uEi8KE3ZhbGlkYXRpb25fZmluZGluZ3MYFCADKAlSEnZhbGlkYXRpb25GaW5kaW5ncw==');
...
const BinkyNetDevice$json = const {
  ...
  '2': const [
    ...
    const {'1': 'router_id', '3': 6, '4': 1, '5': 9, '10': 'routerId'},
...
final $typed_data.Uint8List binkyNetDeviceDescriptor = $convert.base64Decode('');
...
@$core.Deprecated('Use railPointDescriptor instead')
const RailPoint$json = const {
  '1': 'RailPoint',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
...
/// Descriptor for `RailPointRef`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List railPointRefDescriptor = $convert.base64Decode('CgxSYWlsUG9pbnRSZWYSDgoCaWQYASABKAlSAmlk');
