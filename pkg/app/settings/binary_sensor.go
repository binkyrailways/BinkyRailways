...
// NewBinarySensorSettings constructs a settings component for a BinarySensor.
func NewBinarySensorSettings(entity model.BinarySensor) Settings {
	s := &binarySensorSettings{
		entity: entity,
	}
...
// binarySensorSettings implements an settings grid for a BinarySensor.
type binarySensorSettings struct {
	entity model.BinarySensor
