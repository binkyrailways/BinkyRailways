...
type CommandStationState struct {
	...
	// Status of binynet command station
	BinkynetCommandStation *BinkyNetCommandStationState `protobuf:"bytes,2,opt,name=binkynet_command_station,json=binkynetCommandStation,proto3" json:"binkynet_command_station,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                     `json:"-"`
	XXX_unrecognized       []byte                       `json:"-"`
	XXX_sizecache          int32                        `json:"-"`
}
...
func (m *CommandStationState) GetBinkynetCommandStation() *BinkyNetCommandStationState {
	if m != nil {
...
// State specific to BinkyNet command station
type BinkyNetCommandStationState struct {
	// Gets the state of local workers on the Binky network
	// that this command station is attached to.
	LocalWorkers         []*BinkyNetLocalWorkerState `protobuf:"bytes,1,rep,name=local_workers,json=localWorkers,proto3" json:"local_workers,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}

func (m *BinkyNetCommandStationState) Reset()         { *m = BinkyNetCommandStationState{} }
func (m *BinkyNetCommandStationState) String() string { return proto.CompactTextString(m) }
func (*BinkyNetCommandStationState) ProtoMessage()    {}
func (*BinkyNetCommandStationState) Descriptor() ([]byte, []int) {
	return fileDescriptor_7ba3d7758196798e, []int{3}
}
func (m *BinkyNetCommandStationState) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BinkyNetCommandStationState) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BinkyNetCommandStationState.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BinkyNetCommandStationState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BinkyNetCommandStationState.Merge(m, src)
}
func (m *BinkyNetCommandStationState) XXX_Size() int {
	return m.Size()
}
func (m *BinkyNetCommandStationState) XXX_DiscardUnknown() {
	xxx_messageInfo_BinkyNetCommandStationState.DiscardUnknown(m)
}

var xxx_messageInfo_BinkyNetCommandStationState proto.InternalMessageInfo

func (m *BinkyNetCommandStationState) GetLocalWorkers() []*BinkyNetLocalWorkerState {
	if m != nil {
...
// State specific to BinkyNet local worker
type BinkyNetLocalWorkerState struct {
	// Model of the local worker
	Model *BinkyNetLocalWorker `protobuf:"bytes,1,opt,name=model,proto3" json:"model,omitempty"`
	// Uptime in seconds
...
func (m *BinkyNetLocalWorkerState) Reset()         { *m = BinkyNetLocalWorkerState{} }
func (m *BinkyNetLocalWorkerState) String() string { return proto.CompactTextString(m) }
func (*BinkyNetLocalWorkerState) ProtoMessage()    {}
func (*BinkyNetLocalWorkerState) Descriptor() ([]byte, []int) {
	return fileDescriptor_7ba3d7758196798e, []int{4}
}
func (m *BinkyNetLocalWorkerState) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BinkyNetLocalWorkerState) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BinkyNetLocalWorkerState.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BinkyNetLocalWorkerState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BinkyNetLocalWorkerState.Merge(m, src)
}
func (m *BinkyNetLocalWorkerState) XXX_Size() int {
	return m.Size()
}
func (m *BinkyNetLocalWorkerState) XXX_DiscardUnknown() {
	xxx_messageInfo_BinkyNetLocalWorkerState.DiscardUnknown(m)
}

var xxx_messageInfo_BinkyNetLocalWorkerState proto.InternalMessageInfo

func (m *BinkyNetLocalWorkerState) GetModel() *BinkyNetLocalWorker {
	if m != nil {
		return m.Model
	}
	return nil
...
func (m *BinkyNetLocalWorkerState) GetUptime() int64 {
	if m != nil {
		return m.Uptime
	}
	return 0
...
func (*SignalState) Descriptor() ([]byte, []int) {
	return fileDescriptor_7ba3d7758196798e, []int{13}
}
...
func init() {
	...
	proto.RegisterType((*BinkyNetCommandStationState)(nil), "binkyrailways.v1.BinkyNetCommandStationState")
	proto.RegisterType((*BinkyNetLocalWorkerState)(nil), "binkyrailways.v1.BinkyNetLocalWorkerState")
...
var fileDescriptor_7ba3d7758196798e = []byte{
	...
	,
}
...
func (m *BinkyNetCommandStationState) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BinkyNetCommandStationState) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BinkyNetCommandStationState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BinkyNetLocalWorkerState) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BinkyNetLocalWorkerState) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BinkyNetLocalWorkerState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BinkyNetCommandStationState) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BinkyNetLocalWorkerState) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CommandStationState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.BinkynetCommandStation == nil {
				m.BinkynetCommandStation = &BinkyNetCommandStationState{}
			}
...
func (m *BinkyNetCommandStationState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BinkyNetCommandStationState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BinkyNetCommandStationState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.LocalWorkers = append(m.LocalWorkers, &BinkyNetLocalWorkerState{})
...
func (m *BinkyNetLocalWorkerState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BinkyNetLocalWorkerState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BinkyNetLocalWorkerState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
