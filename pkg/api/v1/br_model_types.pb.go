...
type Module struct {
	...
	// Rail points of this module
	RailPoints []*RailPointRef `protobuf:"bytes,108,rep,name=railPoints,proto3" json:"railPoints,omitempty"`
...
func (m *Module) GetRailPoints() []*RailPointRef {
	if m != nil {
		return m.RailPoints
	}
	return nil
...
type BinkyNetLocalWorker struct {
	...
	// If set, contains validation findings
	ValidationFindings   []string `protobuf:"bytes,20,rep,name=validation_findings,json=validationFindings,proto3" json:"validation_findings,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *BinkyNetLocalWorker) GetValidationFindings() []string {
	if m != nil {
		return m.ValidationFindings
	}
	return nil
}
...
func (m *BinkyNetRouter) GetValidationFindings() []string {
	if m != nil {
		return m.ValidationFindings
	}
	return nil
...
func (m *BinkyNetDevice) GetValidationFindings() []string {
	if m != nil {
		return m.ValidationFindings
	}
	return nil
...
type BinkyNetObject struct {
	...
	// If set, use GLOBAL address instead of module alias
	UseGlobalAddress bool `protobuf:"varint,6,opt,name=use_global_address,json=useGlobalAddress,proto3" json:"use_global_address,omitempty"`
	// If set, contains validation findings
	ValidationFindings   []string `protobuf:"bytes,20,rep,name=validation_findings,json=validationFindings,proto3" json:"validation_findings,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
...
func (m *BinkyNetObject) GetUseGlobalAddress() bool {
	if m != nil {
		return m.UseGlobalAddress
	}
	return false
}

func (m *BinkyNetObject) GetValidationFindings() []string {
	if m != nil {
		return m.ValidationFindings
	}
	return nil
...
type Route struct {
	...
	RailPoints []*RailPointRef `protobuf:"bytes,9,rep,name=rail_points,json=railPoints,proto3" json:"rail_points,omitempty"`
...
func (m *Route) GetRailPoints() []*RailPointRef {
	if m != nil {
		return m.RailPoints
	}
	return nil
...
func (m *RailPoint) Reset()         { *m = RailPoint{} }
func (m *RailPoint) String() string { return proto.CompactTextString(m) }
func (*RailPoint) ProtoMessage()    {}
func (*RailPoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_054508b9601a8429, []int{48}
}
func (m *RailPoint) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RailPoint) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RailPoint.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RailPoint) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RailPoint.Merge(m, src)
}
func (m *RailPoint) XXX_Size() int {
	return m.Size()
}
func (m *RailPoint) XXX_DiscardUnknown() {
	xxx_messageInfo_RailPoint.DiscardUnknown(m)
}

var xxx_messageInfo_RailPoint proto.InternalMessageInfo

func (m *RailPoint) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *RailPoint) GetDescription() string {
	if m != nil {
		return m.Description
	}
	return ""
...
func (m *RailPoint) GetModuleId() string {
	if m != nil {
		return m.ModuleId
	}
	return ""
...
func (m *RailPoint) GetPosition() *Position {
	if m != nil {
		return m.Position
	}
	return nil
...
// Reference to a RailPoint
type RailPointRef struct {
	// ID of the RailPoint
	Id                   string   `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
...
func (m *RailPointRef) Reset()         { *m = RailPointRef{} }
func (m *RailPointRef) String() string { return proto.CompactTextString(m) }
func (*RailPointRef) ProtoMessage()    {}
func (*RailPointRef) Descriptor() ([]byte, []int) {
	return fileDescriptor_054508b9601a8429, []int{49}
}
func (m *RailPointRef) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RailPointRef) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RailPointRef.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RailPointRef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RailPointRef.Merge(m, src)
}
func (m *RailPointRef) XXX_Size() int {
	return m.Size()
}
func (m *RailPointRef) XXX_DiscardUnknown() {
	xxx_messageInfo_RailPointRef.DiscardUnknown(m)
}

var xxx_messageInfo_RailPointRef proto.InternalMessageInfo

func (m *RailPointRef) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*RailPoint)(nil), "binkyrailways.v1.RailPoint")
	proto.RegisterType((*RailPointRef)(nil), "binkyrailways.v1.RailPointRef")
}
...
var fileDescriptor_054508b9601a8429 = []byte{
	...
	,
}
...
func (m *Module) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RailPoints) > 0 {
		for iNdEx := len(m.RailPoints) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.RailPoints[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *BinkyNetLocalWorker) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ValidationFindings) > 0 {
		for iNdEx := len(m.ValidationFindings) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ValidationFindings[iNdEx])
			copy(dAtA[i:], m.ValidationFindings[iNdEx])
			i = encodeVarintBrModelTypes(dAtA, i, uint64(len(m.ValidationFindings[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xa2
...
func (m *RailPoint) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RailPoint) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RailPoint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RailPointRef) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RailPointRef) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RailPointRef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BinkyNetLocalWorker) Size() (n int) {
	...
	if len(m.ValidationFindings) > 0 {
		for _, s := range m.ValidationFindings {
			l = len(s)
			n += 2 + l + sovBrModelTypes(uint64(l))
		}
	}
...
func (m *RailPointRef) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Module) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 108:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RailPoints", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RailPoints = append(m.RailPoints, &RailPointRef{})
			if err := m.RailPoints[len(m.RailPoints)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 200:
...
func (m *BinkyNetLocalWorker) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidationFindings", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ValidationFindings = append(m.ValidationFindings, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipBrModelTypes(dAtA[iNdEx:])
...
func (m *BinkyNetObject) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseGlobalAddress", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *RailPoint) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RailPoint: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RailPoint: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RailPointRef) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RailPointRef: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RailPointRef: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
