...
type GetStateChangesRequest struct {
	...
	// If set, only all state objects will be send to the stream, after which the stream is closed.
...
type SetAutomaticControlRequest struct {
	// If set, automatic control will be turned on, otherwise it will be turned off.
	Enabled              bool     `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
var fileDescriptor_a476a990e66ccc93 = []byte{
	...
	,
}
