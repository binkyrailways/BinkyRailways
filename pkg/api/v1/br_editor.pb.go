...
var fileDescriptor_ea4c8988456ab2c0 = []byte{
	...
	0xd4, 0xe0, 0x0c, 0x62, 0xca, 0x4c, 0x31, 0xba, 0xcc, 0xcc, 0xc5, 0xeb, 0x0a, 0x36, 0x2f, 0x38,
	...
	0x4a, 0x02, 0x53, 0x12, 0xaa, 0xcd, 0x89, 0x8b, 0x07, 0xe2, 0x09, 0x28, 0x1f, 0xa7, 0x4a, 0x3c,
	0x66, 0xd8, 0x70, 0xb1, 0xb9, 0xa7, 0x96, 0xf8, 0xe4, 0x27, 0xe3, 0x77, 0x84, 0x28, 0xa6, 0x24,
	0x48, 0x8f, 0x25, 0x17, 0x27, 0xc4, 0x05, 0x20, 0x0e, 0x76, 0x35, 0x38, 0xb4, 0x3a, 0x39, 0x9f,
	0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x33, 0x1e, 0xcb, 0x31,
	0x44, 0x19, 0xa6, 0x67, 0x96, 0x64, 0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0xa3, 0x68, 0xd1,
	0x77, 0x02, 0xf1, 0x82, 0x60, 0xbc, 0x82, 0xec, 0x74, 0xfd, 0xc4, 0x82, 0x4c, 0xfd, 0x32, 0xc3,
	0x24, 0x36, 0x70, 0xf2, 0x31, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xfd, 0x48, 0x64, 0x71, 0x73,
	0x02, 0x00, 0x00,
}
...
func (c *editorServiceClient) GetLoc(ctx context.Context, in *IDRequest, opts ...grpc.CallOption) (*Loc, error) {
	out := new(Loc)
	err := c.cc.Invoke(ctx, "/binkyrailways.v1.EditorService/GetLoc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *editorServiceClient) UpdateLoc(ctx context.Context, in *Loc, opts ...grpc.CallOption) (*Loc, error) {
	out := new(Loc)
	err := c.cc.Invoke(ctx, "/binkyrailways.v1.EditorService/UpdateLoc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedEditorServiceServer) GetLoc(ctx context.Context, req *IDRequest) (*Loc, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLoc not implemented")
}
func (*UnimplementedEditorServiceServer) UpdateLoc(ctx context.Context, req *Loc) (*Loc, error) {
...
func _EditorService_GetLoc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EditorServiceServer).GetLoc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/binkyrailways.v1.EditorService/GetLoc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EditorServiceServer).GetLoc(ctx, req.(*IDRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EditorService_UpdateLoc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Loc)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EditorServiceServer).UpdateLoc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/binkyrailways.v1.EditorService/UpdateLoc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EditorServiceServer).UpdateLoc(ctx, req.(*Loc))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _EditorService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetLoc",
			Handler:    _EditorService_GetLoc_Handler,
		},
		{
			MethodName: "UpdateLoc",
			Handler:    _EditorService_UpdateLoc_Handler,
		},
	},
