...
{
    /// <summary>
    /// UI type editor for modules in a module connection
    /// </summary>
    internal class ModuleEditor : UITypeEditor
    {
        /// <summary>
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            if ((context != null) && (context.Instance != null) && (provider != null))
            {
                ...
                if (editorService != null)
                {
                    // Create a listbox
                    var lb = new ListBox();
                    lb.Items.AddRange(railway.GetModules().OrderBy(x => x.ToString(), NameWithNumbersComparer.Instance).ToArray());
