...
namespace LocoNetToolBox.Protocol
{
    ...
    /// OPC_LINK_SLOTS
    /// </summary>
    public class LinkSlotsRequest : Request
    {
        /// <summary>
        /// Default ctor
        /// </summary>
        public LinkSlotsRequest(int slot1, int slot2)
        {
            Slot1 = slot1;
            Slot2 = slot2;
        }
        ...
        /// Parse ctor
        /// </summary>
        public LinkSlotsRequest(byte[] msg)
        {
            Slot1 = msg[1];
            Slot2 = msg[2];
        }
        ...
        {
            return string.Format("OPC_LINK_SLOTS sl1:{0} sl2:{1}", Slot1, Slot2);
        }
    }
}
